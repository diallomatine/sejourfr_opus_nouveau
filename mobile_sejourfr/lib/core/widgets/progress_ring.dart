    ...
    return SizedBox(
      ...
      child: TweenAnimationBuilder<double>(
        ...
        builder: (context, animated, _) => CustomPaint(
          painter: _RingPainter(value: animated, stroke: stroke, color: color),
          child: Center(
            child: Column(
              ...
              children: [
                Text(
                  label ?? '${value.round()}%',
                  style: AppFonts.display(size: size * 0.27, height: 1.0),
                ),
                if (sub != null)
                  Text(
                    sub!,
                    style: AppFonts.ui(size: 10, color: AppColors.inkFaint),
                  ),
              ],
            ),
          ),
