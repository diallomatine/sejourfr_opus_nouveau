...
/// Section « Historique » du hub Civique d'un thème : top 3 examens
/// thème-scopés terminés + lien « Tout voir » vers la page d'examens.
/// Pendant de `QcmHistorySection` — score affiché en `score/total` (pas
/// pondéré) car les examens civique n'ont pas de scoring CECRL.
class CiviqueHistorySection extends StatelessWidget {
  const CiviqueHistorySection({
    super.key,
    ...
    if (finished.isEmpty) {
      return Padding(
        ...
        child: Container(
          ...
          child: Text(
            'Aucun examen passé. Lance un examen blanc ou entraîne-toi par lot.',
...
class _HistoryRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final scoreColor = _scoreColor(score, total);
  ...
  Color _scoreColor(int? score, int total) {
    if (score == null || total == 0) return AppColors.muted;
