...
/// Bandeau « Lancer un examen blanc » du hub Civique d'un thème. Même look
/// que `ExamBlancHero` de la home : dégradé bleu plein, ombre teintée,
/// texte blanc, CTA pill blanche.
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: AppColors.blueDark.withValues(alpha: 0.32),
                blurRadius: 24,
          ...
          child: Column(
            ...
            children: [
              ...
              _HeroCta(label: 'Commencer', accent: AppColors.blueDark, onTap: onStart),
            ],
          ),
        ),
      ),
