...
/// Builder utilitaire pour les slots d'examens blancs Civique GLOBAUX
/// (40 Q tous thèmes, 45 min, seuil 32). Extrait de
/// `CiviqueFullExamsScreen` pour rester sous la limite de 400 lignes.
/// Pendant de `CiviqueExamSlotBuilder` (examens thème, 20 Q).
class CiviqueFullExamSlotBuilder {
  const CiviqueFullExamSlotBuilder({
