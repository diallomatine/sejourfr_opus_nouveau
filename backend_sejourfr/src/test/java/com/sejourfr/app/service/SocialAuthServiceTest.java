...
class SocialAuthServiceTest {
    ...
    void loginWithGoogle_existingByProvider_login_noCreate_noWelcome() {
        ...
        TokenResponse resp = service.loginWithGoogle(new GoogleSignInRequest("tok", null, null, null, null), "ua", "ip", CTX);
    ...
    void loginWithGoogle_existingByEmail_matchesWithoutMutatingProvider() {
        ...
        service.loginWithGoogle(new GoogleSignInRequest("tok", null, null, null, null), "ua", "ip", CTX);
    ...
    void loginWithApple_newUser_usesClientNameOverrides() {
        ...
        service.loginWithApple(new AppleSignInRequest("idtok", " Jean ", " Dupont ", null, null, null, null), "ua", "ip", CTX);
    ...
    void connexionSocialeExistante_estUnLogin_etNeReecritPasLIdentifiantDuCompte() {
        ...
        service.loginWithGoogle(new GoogleSignInRequest("tok", anon.toString(), null, null, null), "ua", "ip", CTX);
