...
class AuthenticatedRoutesSecurityIT extends AbstractIntegrationTest {
    ...
    static Stream<Arguments> authenticatedRoutes() {
        return Stream.of(
                ...
                Arguments.of(HttpMethod.GET, "/api/me/email-preferences"),
                Arguments.of(HttpMethod.PATCH, "/api/me/email-preferences"),
                ...
                // ExamSlotsController
                Arguments.of(HttpMethod.GET, "/api/exam-slots?epreuve=TCF_CO"),
