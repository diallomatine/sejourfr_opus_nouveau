...
('f5000001-0000-0000-0000-000000000003', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CSP', 'CONNAISSANCE',
 'Que designe un numéro d''urgence en France ?',
...
(gen_random_uuid(), 'f5000001-0000-0000-0000-000000000003', 'Un numéro réserve aux fonctionnaires', FALSE, 2),
...
('f5000001-0000-0000-0000-000000000004', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'MISE_SITUATION',
 ...
 'Il faut s''assurer (assurance auto obligatoire), avoir le certificat d''immatriculation (carte grise) du vehicule, respecter le Code de la route, et avoir un contrôle technique à jour.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f5000001-0000-0000-0000-000000000004', 'Acheter un nouveau vehicule chaque année', FALSE, 2),
...
('f5000001-0000-0000-0000-000000000007', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 'Que désigne le ''travail non declare'' en droit français ?',
 'Le travail non déclare (travail dissimule, travail au noir) est l''exercice d''une activité remuneree sans déclaration aux organismes sociaux et fiscaux. C''est un delit puni par la loi.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-000000000008', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 ...
 'Le salaire doit respecter le SMIC (minimum légal), la convention collective applicable (qui peut fixer un minimum supérieur), et le contrat de travail. Il doit être verse mensuellement.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-000000000009', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 ...
 'Le SMIC (Salaire minimum interprofessionnel de croissance) est le salaire horaire minimum légal en France. Il est revalorise chaque année (au 1er janvier) en fonction de l''inflation.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-00000000000a', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'MISE_SITUATION',
 'Quelle est la première demarche pour rechercher un emploi en France ?',
 'S''inscrire a France Travail (ex Pole emploi) permet de bénéficier d''un accompagnement, d''offres d''emploi, et éventuellement d''une indemnisation chomage si on a déjà cotise.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f5000001-0000-0000-0000-00000000000a', 'Aucune demarche spécifique', FALSE, 3);
...
('f5000001-0000-0000-0000-00000000000b', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CSP', 'CONNAISSANCE',
 ...
 'La durée légale du travail est de 35 heures par semaine pour un salarié à temps plein. Au-dela, ce sont des heures supplementaires (majorees).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-00000000000c', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 'Qui est accompagné par France Travail (ex Pole emploi) ?',
 'France Travail accompagné les personnes en recherche d''emploi : chomeurs (avec ou sans indemnites), salariés cherchant a changer de poste, jeunes diplômes, personnes en reconversion.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-00000000000d', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'MISE_SITUATION',
 'Une personne étrangère en situation reguliere peut-elle créer son entreprise en France ?',
 'Oui. Une personne étrangère en situation reguliere peut créer son entreprise en France. Certains titres de sejour permettent expressement l''exercice d''une activité professionnelle.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-00000000000e', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CSP', 'MISE_SITUATION',
 ...
 'Oui. Les femmes ont exactement les mêmes droits que les hommes pour créer une entreprise. Il n''existe aucune restriction liee au sexe. Diverses aides existent même pour encourager l''entrepreneuriat feminin.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f5000001-0000-0000-0000-00000000000e', 'Oui, comme tout le monde, avec des aides spécifiques possibles', TRUE, 0),
(gen_random_uuid(), 'f5000001-0000-0000-0000-00000000000e', 'Non, c''est réserve aux hommes', FALSE, 1),
...
('f5000001-0000-0000-0000-00000000000f', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 'À quel âge un mineur peut-il commencer a travailler en France ?',
 'Un mineur peut travailler à partir de 14 ans pour des travaux legers et adaptes, avec autorisation parentale. À partir de 16 ans, il peut être apprenti ou salarié ordinaire (avec encore des restrictions).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f5000001-0000-0000-0000-00000000000f', '14 ans (travaux legers), 16 ans (salarié/apprenti)', TRUE, 0),
