...
('f3000002-0000-0000-0000-000000000033', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'L''article 1er de la Déclaration de 1789 enonce : ''Les hommes naissent et demeurent libres et égaux en droits.'' Il pose le principe d''égalité et de liberté.',
 FALSE);
...
('f3000002-0000-0000-0000-000000000034', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'L''article 2 de la DDHC de 1789 cite quatre droits naturels et imprescriptibles : la liberté, la propriété, la sûreté (sécurité) et la resistance à l''oppression.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000034', 'Liberté, propriété, sûreté et resistance à l''oppression', TRUE, 0),
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000034', 'Travail, famille, patrie', FALSE, 1),
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000034', 'Sante, éducation, retraite', FALSE, 2),
...
('f3000002-0000-0000-0000-000000000035', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'L''article 4 enonce : ''La liberté consiste a pouvoir faire tout ce qui ne nuit pas a autrui''. Elle s''arrete la ou commence celle des autres.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000035', 'La liberté est de faire ce qui ne nuit pas a autrui', TRUE, 0),
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000035', 'La liberté est totale sans limite', FALSE, 1),
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000035', 'La liberté est reservée aux nobles', FALSE, 2),
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000035', 'La liberté est definie par le pape', FALSE, 3);
...
('f3000002-0000-0000-0000-000000000036', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Oui. L''article 9 dispose : ''Tout homme etant présumé innocent jusqu''à ce qu''il ait été declaré coupable...'' C''est un principe fondamental du droit pénal français.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000036', 'Oui, mais réserve aux Français', FALSE, 3);
...
('f3000002-0000-0000-0000-000000000038', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 'Quel article de la DDHC etablit la liberté d''expression ?',
 'L''article 11 de la DDHC dispose que ''la libre communication des pensees et des opinions est un des droits les plus précieux de l''homme''. C''est le fondement de la liberté d''expression.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000039', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Non. La liberté d''expression est limitée par la loi (injure, diffamation, incitation à la haine, apologie du terrorisme, atteinte à la vie privée). Ces limites visent a proteger autrui.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f3000002-0000-0000-0000-00000000003a', 'Le droit à la sante', FALSE, 2),
...
('f3000002-0000-0000-0000-00000000003b', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 'Le droit à la vie privée est-il protege en France ?',
...
('f3000002-0000-0000-0000-00000000003c', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Le droit à l''image protege chacun contre l''utilisation non autorisée de son image. La diffusion sans consentement peut donner lieu à des dommages et intérêts et à une condamnation pénale.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-00000000003e', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 'Que prévoit le principe de légalité des delits et des peines ?',
 'Article 8 de la DDHC : ''Nul ne peut être puni qu''en vertu d''une loi établie et promulguee anterieurement au delit''. Une infraction et sa peine doivent être prévues par la loi.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f3000002-0000-0000-0000-00000000003e', 'Le pape détermine les delits', FALSE, 2),
...
('f3000002-0000-0000-0000-00000000003f', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'La présomption d''innocence signifie qu''une personne est considerée innocente tant qu''elle n''a pas été jugée coupable definitivement. C''est la chargé de la preuve qui incombe à l''accusation.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000002-0000-0000-0000-00000000003f', 'L''accuse est présumé innocent jusqu''à condamnation definitive', TRUE, 0),
...
('f3000002-0000-0000-0000-000000000040', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 'Quel est le delai général de prescription pour les delits en France ?',
 'Le delai de prescription pour les delits est de 6 ans depuis 2017 (porte de 3 à 6 ans par la loi du 27 février 2017). Au-dela, l''action publique ne peut plus être exercée.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000041', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Oui. La torture, les traitements inhumains ou degradants sont prohibes par la Constitution, la Convention européenne des droits de l''homme (article 3) et le Code pénal français. C''est une interdiction absolue.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000043', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Oui. La France accordé l''asile aux personnes persecutees dans leur pays en raison de leur action en faveur de la liberté (preambule de la Constitution de 1946). L''OFPRA traité les demandes.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000044', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 'Qu''est-ce que le droit à la dignite humaine ?',
 'Le principe de dignite humaine, principe constitutionnel depuis 1994, protege chaque personne de toute atteinte degradant sa condition d''être humain. Il fonde de nombreux droits fondamentaux.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000044', 'Un droit réserve aux femmes', FALSE, 3);
...
('f3000002-0000-0000-0000-000000000045', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Le preambule de 1946 reconnait notamment : le droit à la sante, à l''éducation, au travail, à la sécurité materielle, au logement, à la participation à la gestion des entreprises.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000045', 'Droit à la sante, éducation, travail, sécurité materielle', TRUE, 0),
...
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000045', 'Droits réserves aux militaires', FALSE, 3);
...
('f3000002-0000-0000-0000-000000000046', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'La loi DALO de 2007 reconnait un droit au logement decent. Les personnes en difficulté peuvent saisir une commission de mediation, voire le tribunal pour faire valoir ce droit.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000046', 'Un recours légal pour obtenir un logement decent', TRUE, 0),
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000046', 'L''attribution automatique d''un logement', FALSE, 1),
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000046', 'Un droit réserve aux fonctionnaires', FALSE, 2),
(gen_random_uuid(), 'f3000002-0000-0000-0000-000000000046', 'Un droit européen non transpose', FALSE, 3);
...
('f3000002-0000-0000-0000-000000000047', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Oui. L''aide juridictionnelle, totale ou partielle, est accordée aux personnes dont les revenus ne depassent pas un certain plafond. Elle permet de payer les frais d''avocat et de procès.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000048', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 'L''esclavage est-il considère comme un crime contre l''humanite en droit français ?',
 'Oui. La loi Taubira de 2001 reconnait la traité negriere et l''esclavage comme crimes contre l''humanite. Le 10 mai est journee nationale de commemoration.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000049', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Les propos haineux (racistes, sexistes, homophobes, etc.) sur internet relevent du droit pénal français (loi de 1881 sur la presse). Les plateformes ont aussi des obligations de moderation (loi Avia/DSA).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-00000000004a', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'La double peine désigne la situation ou un étranger condamné à une peine de prison est ensuite expulse du territoire français. La loi de 2003 a limite cette pratique mais pas supprime.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-00000000004b', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Oui. Les victimes peuvent être indemnisees par la Commission d''indemnisation des victimes d''infractions (CIVI), bénéficier d''un accompagnement par des associations (France Victimes au 116 006).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-00000000004c', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Respecter la loi, payer ses impots, accomplir les obligations militaires (Journee défense et citoyenneté), défendre la patrie, être solidaire, respecter les autres et l''environnement.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000002-0000-0000-0000-00000000004c', 'Respecter la loi, payer ses impots, être solidaire', TRUE, 0),
...
('f3000002-0000-0000-0000-00000000004d', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 'La Journee défense et citoyenneté est-elle obligatoire pour les jeunes Français ?',
 'Oui. Tous les jeunes français (filles et garçons) doivent participer à la Journee défense et citoyenneté (JDC) entre 16 et 25 ans. C''est une condition pour passer le permis ou les concours.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-00000000004e', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'La Charte de l''environnement, adossee à la Constitution depuis 2005, reconnait le droit à un environnement sain et l''obligation pour chacun de proteger l''environnement.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000002-0000-0000-0000-00000000004e', 'Le droit à un environnement sain et le devoir de le proteger', TRUE, 0),
...
('f3000002-0000-0000-0000-00000000004f', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 'Quel principe environnemental impose de prevenir les dommages graves à l''environnement ?',
 'Le principe de précaution (article 5 de la Charte de l''environnement) impose des mesures provisoires pour prevenir un risque grave de dommage à l''environnement, même en cas d''incertitude scientifique.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000050', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Oui. Le harcelement moral est un delit puni par le Code du travail et le Code pénal (article 222-33-2). La victime peut saisir les prud''hommes et porter plainte.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000051', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Oui. Le harcelement sexuel est un delit (article 222-33 du Code pénal) puni de 2 ans de prison et 30 000 EUR d''amende, plus selon les circonstances (mineur, autorité, etc.).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000052', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'La loi Claeys-Leonetti (2016) reconnait le droit à une sedation profonde et continue pour les malades en fin de vie. L''euthanasie active reste interdite ; un débat parlementaire est en cours sur l''aide a mourir.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-0000000000a1', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Le principe de dignite humaine et l''article 3 de la Convention européenne des droits de l''homme prohibent absolument les traitements cruels, inhumains ou degradants, même en temps de guerre.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-0000000000a2', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Le droit à l''oubli permet à une personne de demander le dereferencement (suppression des resultats de recherche) ou l''effacement de données personnelles obsoletes ou inappropriees, garanti par le RGPD.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f3000002-0000-0000-0000-0000000000a2', 'Un droit réserve aux mineurs', FALSE, 2),
...
('f3000002-0000-0000-0000-0000000000a3', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Le RGPD, en vigueur depuis 2018, protège les données personnelles des citoyens européens. Il impose aux entreprises consentement, transparence, sécurité, et accordé plusieurs droits (accès, rectification, effacement).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-0000000000a4', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Oui. Le viol est un crime (article 222-23 du Code pénal), puni de 15 ans de reclusion criminelle, plus selon les circonstances aggravantes (mineur, autorité, etc.).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-0000000000a5', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 'L''incitation à la haine raciale est-elle reprimee en France ?',
 'Oui. La provocation à la haine, la discrimination ou la violence en raison de l''origine, de la religion ou du sexe est un delit puni par la loi de 1881 sur la presse (1 an de prison, 45 000 EUR d''amende).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-0000000000a6', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 'Quel principe protege chacun de la ''rétroactivité'' d''une loi pénale plus severe ?',
 'Le principe de non-retroactivite de la loi pénale plus severe (article 8 DDHC, article 112-1 du Code pénal) interdit d''appliquer une loi nouvelle plus dure aux faits commis avant son entrée en vigueur.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000002-0000-0000-0000-0000000000a6', 'La non-retroactivite de la loi pénale plus severe', TRUE, 0),
...
('f3000002-0000-0000-0000-0000000000a7', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Oui. La loi du 17 mai 2013, dite ''Mariage pour tous'', autorisé le mariage entre personnes de même sexe et leur ouvre l''adoption.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-0000000000a8', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 'Le PACS, créé en 1999, est un contrat conclu entre deux personnes majeures (de même sexe ou non) pour organiser leur vie commune. C''est moins formel que le mariage mais à des effets juridiques.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000053', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 ...
 'Conservez les preuves (mails, témoignages). Alertez le service RH, les représentants du personnel, l''inspection du travail. Saisissez les prud''hommes. Vous pouvez aussi porter plainte penalement.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000054', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 ...
 'Saisissez le Defenseur des droits, deposez plainte pénale (la discrimination au logement est punie de 3 ans de prison et 45 000 EUR d''amende). Une association comme SOS Racisme peut aider.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000055', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 ...
 'Non. Le refus de service fondé sur la religion est une discrimination punie par la loi. Vous pouvez déposer plainte et saisir le Defenseur des droits.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000056', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 ...
 'Vous pouvez demander le retrait au site (procedure prévue par la loi), saisir la CNIL pour les données personnelles, porter plainte (atteinte à la vie privée, droit à l''image) et engager une action civile.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000057', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 ...
 'Alertez immediatement le directeur d''école, ecrivez à l''inspection académique. Le 3018 est dedie au harcelement scolaire. Une plainte pénale est possible (delit de harcelement).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-000000000058', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 'On me reclame une somme d''argent sans justificatif. Comment me défendre ?',
...
('f3000002-0000-0000-0000-000000000059', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 'Mon propriétaire veut m''expulser sans suivre la procedure légale. Est-ce autorisé ?',
 'Non. L''expulsion d''un locataire ne peut se faire que par décision de justice et avec l''intervention d''un huissier. Toute expulsion forcee sans cette procedure est illégale et punie penalement.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-00000000005a', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 ...
 'Vous pouvez contacter la SPA ou une autre association de protection animale, prevenir la police ou la gendarmerie. La maltraitance animale est un delit puni (article 521-1 du Code pénal).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f3000002-0000-0000-0000-00000000005b', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 ...
 'Restez calme et coopere. Vous pouvez demander la raison du contrôle, l''identité du policier. Si vous estimez avoir été maltraite, vous pouvez déposer plainte aupres du procureur ou saisir l''IGPN.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000002-0000-0000-0000-00000000005b', 'Cooperer, demander le motif, déposer plainte si abus', TRUE, 0),
...
('f3000002-0000-0000-0000-00000000005c', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 'On me propose un travail très bien paye mais sans contrat ni déclaration. Que penser ?',
 'C''est du travail dissimule, illégal en France. Vous n''aurez aucun droit social (assurance maladie, retraite, chomage), et vous risquez des sanctions. Refuser et signaler aux autorités.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000002-0000-0000-0000-00000000005c', 'Refuser et signaler : c''est du travail dissimule illégal', TRUE, 0),
