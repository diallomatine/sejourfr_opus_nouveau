...
-- Repartition CSP/CR/NAT calibree par difficulté
-- ============================================================================
...
VALUES ('f0000001-0000-0000-0000-000000000001', 'CIVIQUE',
        ...
        'Le 14 juillet est la fête nationale française. Elle commemore la prise de la Bastille en 1789, événement majeur de la Révolution française, et la Fête de la Fédération de 1790.',
        TRUE);
...
VALUES ('f0000001-0000-0000-0000-000000000006', 'CIVIQUE',
        ...
        'Le drapeau français est composé de trois bandes verticales : bleu, blanc et rouge, de gauche a droite quand on le regarde.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
VALUES ('f0000001-0000-0000-0000-000000000008', 'CIVIQUE',
        '11111111-0000-0000-0000-000000000001', 'CR', 'CONNAISSANCE',
        'Qui est Marianne ?',
        'Marianne est l''allegorie (la représentation symbolique) de la République française. Son buste est present dans toutes les mairies de France.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
VALUES (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000008', 'L''allegorie de la République française',
        TRUE, 0),
       (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000008', 'La première reine de France', FALSE, 1),
       (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000008', 'L''epouse du président actuel', FALSE, 2),
...
VALUES ('f0000001-0000-0000-0000-000000000009', 'CIVIQUE',
        ...
        'La Marseillaise est l''hymne national de la France. Ecrite par Rouget de Lisle en 1792 à Strasbourg, elle est devenue hymne national en 1795.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
VALUES ('f0000001-0000-0000-0000-00000000000a', 'CIVIQUE',
        ...
        'La Marseillaise est l''hymne national de la France. Elle est chantee lors des cérémonies officielles et des événements sportifs internationaux.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
VALUES ('f0000001-0000-0000-0000-00000000000b', 'CIVIQUE',
        ...
        'La devise "Liberté, Égalité, Fraternité" est inscrite à l''article 2 de la Constitution. Elle resume les valeurs fondamentales de la République.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
VALUES ('f0000001-0000-0000-0000-00000000000c', 'CIVIQUE',
        ...
        'La devise "Liberté, Égalité, Fraternité" est inscrite sur le fronton de tous les batiments publics : mairies, écoles, préfectures, tribunaux.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
VALUES (gen_random_uuid(), 'f0000001-0000-0000-0000-00000000000e',
       ...
       (gen_random_uuid(), 'f0000001-0000-0000-0000-00000000000e', 'L''obligation d''obeir au gouvernement',
        FALSE, 2),
       (gen_random_uuid(), 'f0000001-0000-0000-0000-00000000000e', 'Le droit réserve aux citoyens français',
        FALSE, 3);
...
VALUES (gen_random_uuid(), 'f0000001-0000-0000-0000-00000000000f',
       ...
       (gen_random_uuid(), 'f0000001-0000-0000-0000-00000000000f', 'Tout le monde gagne le même salaire',
        FALSE, 1),
       (gen_random_uuid(), 'f0000001-0000-0000-0000-00000000000f', 'Tout le monde à la même apparence', FALSE,
        2),
...
VALUES ('f0000001-0000-0000-0000-000000000010', 'CIVIQUE',
        ...
        'Le principe d''égalité garantit que la loi s''applique de la même manière à tous, sans discrimination liee à l''origine, au sexe, à la religion ou aux opinions.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
VALUES (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000010',
       ...
       (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000010',
        'Tout le monde doit posseder les mêmes biens', FALSE, 1),
       (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000010',
...
VALUES ('f0000001-0000-0000-0000-000000000011', 'CIVIQUE',
        ...
        'La fraternité représente la solidarité et l''entraide entre les citoyens. Elle implique le respect, la tolerance et le devoir d''aider les autres.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
VALUES ('f0000001-0000-0000-0000-000000000015', 'CIVIQUE',
        ...
        'L''article 1er de la Constitution definit la France comme une République "indivisible, laïque, démocratique et sociale". La laïcité est l''un des quatre principes fondamentaux.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
VALUES ('f0000001-0000-0000-0000-000000000016', 'CIVIQUE',
        ...
        'La fête nationale française est le 14 juillet. Elle commemore la prise de la Bastille en 1789 et la Fête de la Fédération de 1790.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
-- Q23 - Qu'est-ce qui est traditionnellement organise sur les Champs-Élysées le 14 juillet ?
INSERT INTO questions (id, module, theme_id, difficulty, question_type, statement, explanation, is_active)
VALUES ('f0000001-0000-0000-0000-000000000017', 'CIVIQUE',
        '11111111-0000-0000-0000-000000000001', 'CSP', 'CONNAISSANCE',
        'Qu''est-ce qui est traditionnellement organise sur les Champs-Élysées le 14 juillet pour célébrer la fête nationale ?',
        'Un defile militaire est organisé chaque année sur les Champs-Élysées à Paris, en presence du président de la République. C''est la plus ancienne et la plus grande parade militaire d''Europe.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
VALUES (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000017', 'Un defile militaire', TRUE, 0),
       (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000017', 'Un marche de Noël', FALSE, 1),
...
VALUES ('f0000001-0000-0000-0000-000000000019', 'CIVIQUE',
        ...
        'Le français est la langue officielle et de l''administration. Sa connaissance est un element essentiel d''intégration et est exigée pour la naturalisation.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
VALUES (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000019',
       ...
       (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000019', 'C''est une langue reservée à l''ecrit',
        FALSE, 2),
       (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000019',
...
-- Q26 - Quelle liberté permet a chacun d'exprimer ses idées ?
INSERT INTO questions (id, module, theme_id, difficulty, question_type, statement, explanation, is_active)
VALUES ('f0000001-0000-0000-0000-00000000001a', 'CIVIQUE',
        '11111111-0000-0000-0000-000000000001', 'CR', 'CONNAISSANCE',
        'Quelle liberté permet a chacun d''exprimer ses idées ?',
        'La liberté d''expression permet a chacun d''exprimer ses opinions, par la parole, l''ecrit, l''image. Elle est garantié par la Déclaration des droits de l''homme et du citoyen de 1789.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
VALUES ('f0000001-0000-0000-0000-00000000001b', 'CIVIQUE',
        ...
        'La liberté d''expression n''est pas absolue : elle est encadrée par la loi. L''injure, la diffamation, l''incitation à la haine ou à la violence sont interditées.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
VALUES (gen_random_uuid(), 'f0000001-0000-0000-0000-00000000001b',
       ...
       (gen_random_uuid(), 'f0000001-0000-0000-0000-00000000001b', 'Est reservée aux journalistes', FALSE, 3);
...
VALUES ('f0000001-0000-0000-0000-00000000001c', 'CIVIQUE',
        ...
        'Non. Les injures et discriminations sont interditées par la loi et punies penalement. Le respect de la dignite de chacun est un principe fondamental.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
-- Q29 - Certains métiers peuvent-ils être réserves aux hommes ?
INSERT INTO questions (id, module, theme_id, difficulty, question_type, statement, explanation, is_active)
VALUES ('f0000001-0000-0000-0000-00000000001d', 'CIVIQUE',
        '11111111-0000-0000-0000-000000000001', 'CR', 'MISE_SITUATION',
        'Certains métiers peuvent-ils être réserves aux hommes ?',
...
VALUES ('f0000001-0000-0000-0000-00000000001e', 'CIVIQUE',
        ...
        'La laïcité est la separation entre l''État et les religions. L''État est neutre, ne reconnait aucun culte et garantit la liberté de conscience de chacun.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
VALUES (gen_random_uuid(), 'f0000001-0000-0000-0000-00000000001e',
        'La separation entre l''État et les religions', TRUE, 0),
...
-- Q31 - En quelle année la loi de separation des Églises et de l'État a-t-elle été votée ?
INSERT INTO questions (id, module, theme_id, difficulty, question_type, statement, explanation, is_active)
VALUES ('f0000001-0000-0000-0000-00000000001f', 'CIVIQUE',
        ...
        'La loi de separation des Églises et de l''État a été votée le 9 décembre 1905. Elle posé les bases de la laïcité française.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
...
VALUES (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000022',
       ...
       (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000022', 'Parce que les religions sont interditées',
        FALSE, 1),
...
VALUES ('f0000001-0000-0000-0000-000000000024', 'CIVIQUE',
        ...
        'Oui. La liberté de conscience, garantie par la laïcité, comprend le droit de ne pas croire (athe, agnostique). Personne ne peut être force a adherer à une religion.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
VALUES (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000024',
        'Oui, la liberté de conscience est garantié', TRUE, 0),
...
VALUES ('f0000001-0000-0000-0000-000000000025', 'CIVIQUE',
        ...
        'Oui. La liberté de conscience inclut le droit de choisir, changer ou abandonner une religion sans aucune contrainte. Nul ne peut être force de rester dans une religion.',
        TRUE);
INSERT INTO choices (id, question_id, label, is_correct, display_order)
