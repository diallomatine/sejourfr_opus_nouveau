...
('f5000001-0000-0000-0000-000000000011', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 ...
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f5000001-0000-0000-0000-000000000011', 'Garantie à tous les résidents reguliers via la PUMA', TRUE, 0),
...
('f5000001-0000-0000-0000-000000000012', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CSP', 'MISE_SITUATION',
 'En cas de problème de sante non urgent, vers qui se diriger en premier ?',
 'Le médecin traitant (médecin generaliste) est le premier interlocuteur pour les problèmes de sante non urgents. Il oriente vers un spécialiste si nécessaire (parcours de soins coordonne).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f5000001-0000-0000-0000-000000000013', 'Operer en hôpital', FALSE, 1),
...
('f5000001-0000-0000-0000-000000000014', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'MISE_SITUATION',
 ...
 'Les urgences sont reservées aux situations médicales graves, soudaines ou potentiellement dangereuses : douleur thoracique, perte de connaissance, hemorragie, trauma serieux. Pour les soins non urgents, voir le médecin traitant ou SOS Médecins.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-000000000015', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 ...
 'Les vaccinations obligatoires protegent l''individu et l''ensemble de la population (immunité collective). Depuis 2018, 11 vaccins sont obligatoires pour les nourrissons (rougeole, tetanos, etc.).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f5000001-0000-0000-0000-000000000015', 'Pour proteger l''individu et l''immunité collective', TRUE, 0),
...
('f5000001-0000-0000-0000-000000000016', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 ...
 'La carte Vitale prouve l''affiliation à la Sécurité sociale. Elle permet aux professionnels de sante de transmettre les feuilles de soins electroniquement et d''être rembourse rapidement.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-000000000017', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 'À quoi sert une complementaire sante (mutuelle) ?',
 'La mutuelle complète les remboursements de la Sécurité sociale (qui ne rembourse pas toujours 100% des frais). Elle peut couvrir des soins comme l''optique, le dentaire, l''audioprothese.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f5000001-0000-0000-0000-000000000017', 'Completer les remboursements de la Sécurité sociale', TRUE, 0),
...
('f5000001-0000-0000-0000-000000000018', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CSP', 'CONNAISSANCE',
 ...
 'L''instruction est obligatoire jusqu''à 16 ans (loi de 1959, abaissee à 3 ans en 2019). L''obligation de formation a été instaurée jusqu''à 18 ans depuis 2020.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-000000000019', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 ...
 'L''autorité parentale impose aux parents (ensemble en général) de proteger, eduquer, nourrir et soigner leur enfant mineur, jusqu''à sa majorité ou son émancipation.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-00000000001b', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CSP', 'CONNAISSANCE',
 ...
 'Le baccalaureat (général, technologique ou professionnel) est le diplôme obtenu en fin de lycée. Il permet d''accéder à l''enseignement supérieur.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f5000001-0000-0000-0000-00000000001c', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 'Après l''école elementaire, dans quel établissement vont les élèves ?',
 'Après l''école elementaire (CP a CM2), les élèves entrent au collège (6e à 3e), puis au lycée (2nde a Terminale). Le collège accueille tous les enfants jusqu''au brevet.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f5000001-0000-0000-0000-00000000001d', 'Uniquement les Français nes en France', FALSE, 1),
...
('f5000001-0000-0000-0000-00000000001e', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'CONNAISSANCE',
 ...
 'L''inscription à l''école publique se fait à la mairie (puis à l''école). Elle implique des droits (instruction gratuite, restauration scolaire) et des obligations (assiduite, respect du règlement).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f5000001-0000-0000-0000-00000000001e', 'Inscription à la mairie, instruction gratuite, assiduite obligatoire', TRUE, 0),
...
('f5000001-0000-0000-0000-00000000001f', 'CIVIQUE', '11111111-0000-0000-0000-000000000005', 'CR', 'MISE_SITUATION',
 ...
 'L''Éducation nationale propose un accompagnement spécifique : UPE2A (unité pedagogique pour élèves allophones arrivants), enseignants formes au FLE/FLS, soutien linguistique adapte.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
