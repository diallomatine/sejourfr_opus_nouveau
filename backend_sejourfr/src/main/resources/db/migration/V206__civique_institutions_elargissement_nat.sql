...
('f2000002-0000-0000-0000-00000000006a', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'La IVe République souffrait d''instabilite gouvernementale chronique et a été renversee par la crise algerienne de mai 1958, ouvrant la voie à la Ve République avec de Gaulle.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-00000000006b', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 'En quelle année le quinquennat présidentiel a-t-il remplace le septennat ?',
 'Le quinquennat a remplace le septennat suite au référendum du 24 septembre 2000. Le premier président élu pour 5 ans a été Jacques Chirac en 2002.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-00000000006d', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 'Quel référendum de 1962 a transforme l''élection du président ?',
 'Le référendum du 28 octobre 1962 a instaure l''élection du président au suffrage universel direct, sur l''initiative de Charles de Gaulle.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f2000002-0000-0000-0000-00000000006d', 'Le référendum de 1962 sur le suffrage direct', TRUE, 0),
(gen_random_uuid(), 'f2000002-0000-0000-0000-00000000006d', 'Le référendum sur l''Algerie', FALSE, 1),
...
('f2000002-0000-0000-0000-00000000006e', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'La cohabitation désigne la situation ou le président de la République et le Premier ministre appartiennent à des bords politiques opposés. Trois cohabitations ont eu lieu : 1986-88, 1993-95, 1997-2002.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f2000002-0000-0000-0000-00000000006e', 'Président et Premier ministre de bords opposés', TRUE, 0),
(gen_random_uuid(), 'f2000002-0000-0000-0000-00000000006e', 'Deux présidents simultanes', FALSE, 1),
...
('f2000002-0000-0000-0000-00000000006f', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'L''article 16 de la Constitution autorisé le président, en cas de menace grave et immediate sur les institutions, a prendre des mesures exceptionnelles. Il n''a été utilise qu''une fois, en 1961 par de Gaulle.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000070', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 'Combien de fois l''article 16 de la Constitution a-t-il été utilise depuis 1958 ?',
 'L''article 16 (pouvoirs exceptionnels) n''a été appliqué qu''une seule fois, par Charles de Gaulle du 23 avril au 29 septembre 1961, lors du putsch des généraux a Alger.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000071', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'La révision constitutionnelle du 23 juillet 2008 a renforcé le Parlement (contrôle de l''ordre du jour partiellement partage, encadrement du 49.3, création de la QPC) et limite le président (2 mandats consecutifs maximum).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000072', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 'Quel principe limite à deux le nombre de mandats consecutifs du président ?',
 'Depuis la révision de 2008 (article 6 de la Constitution), nul ne peut exercer plus de deux mandats consecutifs comme président de la République.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000074', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Le Conseil constitutionnel compte 9 membres nommes (3 par le président, 3 par le président de l''Assemblée, 3 par le président du Sénat), plus les anciens présidents de la République de droit.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f2000002-0000-0000-0000-000000000074', '9 membres nommes (plus les anciens présidents de droit)', TRUE, 0),
...
('f2000002-0000-0000-0000-000000000075', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Les membres nommes du Conseil constitutionnel sont désignés pour 9 ans, non renouvelables. Le Conseil est renouvelé par tiers tous les 3 ans.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000077', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Non. L''article 89 de la Constitution interdit toute révision portant atteinte à la forme républicaine du gouvernement. C''est l''une des ''clauses d''eternite'' de la Constitution.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000079', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Les magistrats du siège jugent (juges, présidents de tribunaux), les magistrats du parquet poursuivent les infractions au nom de la société (procureurs, substituts). Tous deux relevent de l''autorité judiciaire.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f2000002-0000-0000-0000-000000000079', 'Le siège paie, le parquet recoit', FALSE, 2),
...
('f2000002-0000-0000-0000-00000000007c', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Une loi organique précise l''organisation et le fonctionnement des pouvoirs publics. Elle est adoptée selon une procedure renforcée et est soumise obligatoirement au contrôle du Conseil constitutionnel.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-00000000007d', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'La loi est votée par le Parlement, le décret est pris par le pouvoir exécutif (président ou Premier ministre). Les décrets precisent l''application des lois ou interviennent dans le domaine réglementaire.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-00000000007e', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Oui. L''article 34 enumere les domaines réserves au Parlement (lois). L''article 37 confie au gouvernement les autres domaines (règlements).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-00000000007f', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Le Conseil de l''Union européenne (a distinguer du Conseil européen, qui reunit les chefs d''État) reunit les ministres specialises de chaque pays membre. Il vote les lois avec le Parlement européen.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000080', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Le Conseil européen reunit les chefs d''État et de gouvernement des 27 pays membres, plus le président de la Commission et son président permanent. Il fixe les grandes orientations de l''UE.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f2000002-0000-0000-0000-000000000080', 'Des députés tires au sort', FALSE, 2),
...
('f2000002-0000-0000-0000-000000000081', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Le règlement européen s''applique directement dans tous les États membres sans transposition. La directive fixe des objectifs et laisse les États libres des moyens, avec un delai de transposition en droit national.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f2000002-0000-0000-0000-000000000081', 'Le règlement s''applique directement, la directive doit être transposee', TRUE, 0),
...
('f2000002-0000-0000-0000-000000000082', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Une révision constitutionnelle est adoptée par les deux chambres du Parlement, puis ratifiée soit par référendum, soit par le Congres (Parlement reuni à Versailles) à la majorité des 3/5e.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f2000002-0000-0000-0000-000000000082', 'Vote des deux chambres + référendum ou Congres aux 3/5e', TRUE, 0),
...
('f2000002-0000-0000-0000-000000000083', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'L''article 89 organise la procedure de révision de la Constitution. Il prévoit le vote des deux chambres puis le référendum ou le Congres.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000084', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 'Une loi votée par le Parlement entre-t-elle en vigueur immediatement ?',
 ...
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f2000002-0000-0000-0000-000000000084', 'Non, elle doit être promulguee et publiée au Journal officiel', TRUE, 0),
...
('f2000002-0000-0000-0000-000000000086', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 'Quel est le delai standard pour saisir le Conseil constitutionnel après le vote d''une loi ?',
 'La saisine doit intervenir dans le delai de 15 jours qui suivent la promulgation possible, c''est-à-dire avant que le président ne signe la loi.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000087', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 'Qu''est-ce qu''un référendum d''initiative partagee ?',
 'Le référendum d''initiative partagee (RIP), créé en 2008, permet l''organisation d''un référendum à la demande d''1/5e des parlementaires soutenus par 10% des électeurs inscrits.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f2000002-0000-0000-0000-000000000087', 'Référendum lance par parlementaires + 10% des électeurs', TRUE, 0),
...
('f2000002-0000-0000-0000-000000000088', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Sous la Ve République, environ 10 référendums ont été organisés au niveau national, sur des sujets tels que l''Algerie, l''élection du président, l''Europe, le quinquennat ou les traités européens.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000089', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Le contrôle a posteriori, par voie de Question prioritaire de constitutionnalite (QPC), permet de contester une loi déjà en vigueur si elle porte atteinte aux droits constitutionnels. Cree en 2008.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-00000000008a', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Les collectivites territoriales (communes, départements, régions) disposent d''une part de ressources propres et peuvent fixer le taux de certains impots locaux dans les limites de la loi (article 72-2 de la Constitution).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f2000002-0000-0000-0000-00000000008a', 'Tout est décide par l''État', FALSE, 1),
(gen_random_uuid(), 'f2000002-0000-0000-0000-00000000008a', 'Aucune autonomie financiere', FALSE, 2),
(gen_random_uuid(), 'f2000002-0000-0000-0000-00000000008a', 'Elles depossedent l''État', FALSE, 3);
...
('f2000002-0000-0000-0000-00000000008b', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Le budget de l''État est prepare par le gouvernement (ministère de l''Économie et des Finances), vote par le Parlement chaque automne, et son exécution est controlée par la Cour des comptes.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f2000002-0000-0000-0000-00000000008b', 'Prepare par le gouvernement, vote par le Parlement, contrôle par la Cour des comptes', TRUE, 0),
...
('f2000002-0000-0000-0000-00000000008c', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 'Quelle institution evalue l''exécution des politiques publiques et les comptes de l''État ?',
 'La Cour des comptes est une juridiction financiere indépendante qui contrôle l''usage des fonds publics et publie des rapports souvent commentes dans le débat public.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-00000000008d', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Oui, c''est le Defenseur des droits, autorité constitutionnelle indépendante (depuis 2011) qui defend les droits et libertés des citoyens face aux administrations et lutte contre les discriminations.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-00000000008e', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Le principe de parite, inscrit dans la Constitution depuis 1999 (article 1er, alinea 2), impose aux partis politiques de favoriser l''égal accès des femmes et des hommes aux mandats et fonctions électives.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-00000000008f', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'CONNAISSANCE',
 ...
 'Les campagnes électorales sont strictement encadrées : plafond de depenses, interdiction des dons d''entreprises depuis 1995, remboursement partiel par l''État, contrôle par la Commission nationale des comptes de campagne.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f2000002-0000-0000-0000-00000000008f', 'Plafonnement des depenses et contrôle public', TRUE, 0),
...
('f2000002-0000-0000-0000-000000000091', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'MISE_SITUATION',
 'Un président sortant a déjà effectue deux mandats consecutifs. Peut-il se représenter immediatement après ?',
 'Non. Depuis la révision de 2008 (article 6), un président ne peut pas exercer plus de deux mandats consecutifs. Il devra attendre au moins un mandat avant de se représenter.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000094', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'MISE_SITUATION',
 'Un député français peut-il siéger simultanement au Sénat ?',
...
('f2000002-0000-0000-0000-000000000095', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'MISE_SITUATION',
 'Un parti politique recoit des financements étrangers importants. Que dit le droit ?',
 'Les partis politiques français ne peuvent recevoir aucune contribution ou aide materielle directe ou indirecte d''un État étranger ou d''une personne morale de droit étranger. C''est interdit par la loi.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000096', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'MISE_SITUATION',
 ...
 'Le requerant peut demander au tribunal administratif d''ordonner l''exécution sous astreinte (somme due par jour de retard). Le préfet peut aussi se substituer à la commune dans certains cas.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000097', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'MISE_SITUATION',
 ...
 'Non. Les traités importants (qui modifient des dispositions législatives, engagent les finances, affectent l''état des personnes, cedent ou echangent du territoire) doivent être autorisés par une loi (article 53).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f2000002-0000-0000-0000-000000000098', 'CIVIQUE', '11111111-0000-0000-0000-000000000002', 'NAT', 'MISE_SITUATION',
 ...
 'Le droit européen prime sur le droit national. Un acte contraire peut être conteste devant le juge administratif français (Conseil d''État). La Commission européenne peut aussi engager une procedure d''infraction contre la France.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f2000002-0000-0000-0000-000000000098', 'Recours administratif français + procedure d''infraction européenne', TRUE, 0),
