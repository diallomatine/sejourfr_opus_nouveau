-- ============================================================================
-- V488 — TCF CO : drafts audio B2 (lot 3)
-- ----------------------------------------------------------------------------
...
INSERT INTO audio_question_draft
  (id, difficulty, competence_code, theme_id, transcript_text, ssml_text, statement, explanation,
   ...
   rejection_reason)
VALUES
  ('66666666-00c1-1000-0000-000000000009', 'B2', 'co_dialogue_c1_implicite', '22222222-0000-0000-0000-000000000001',
...
D. Le mot « accueil » est utilisé dans son sens administratif strict, contraire au sens commun.',
  ...
  ('66666666-00c1-1000-0000-00000000000a', 'B2', 'co_dialogue_c1_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Une méfiance compréhensible envers des employeurs jugés peu fiables.',
  ...
  ('66666666-00c1-1000-0000-00000000000b', 'B2', 'co_dialogue_c1_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. À la toute fin, lorsqu''elle a sèchement refusé que je règle son café.',
  ...
  ('66666666-00c1-1000-0000-00000000000c', 'B2', 'co_dialogue_c1_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Un arbitrage discret sur un dossier d''urbanisme cher à l''opposition, voté en échange.',
  ...
  ('66666666-00c1-1000-0000-00000000000d', 'B2', 'co_dialogue_c1_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Que les modalités techniques choisies seront politiquement neutres et consensuelles.',
  ...
  ('66666666-00c1-1000-0000-00000000000f', 'B2', 'co_dialogue_c1_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Un défaut chronique d''outils de mesure partagés entre les deux services.',
  ...
  ('66666666-00c1-1000-0000-000000000010', 'B2', 'co_dialogue_c1_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Qu''ils m''ont gentiment raccompagné jusqu''à la porte.',
   '<speak version="1.0" xml:lang="fr-FR"><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.</prosody></voice><break time="1500ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Alors, ce dîner chez les Marchand, raconte-moi.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Une soirée d''une rare élévation intellectuelle, ma chère.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Tiens donc, à ce point ?</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Oui, j''ai cru défaillir devant tant d''esprit.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Sois honnête : tu en as pensé quoi, vraiment ?</prosody></voice><break time="1000ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">A.<break time="300ms"/>Que c''était d''une platitude consommée, en réalité.<break time="700ms"/>B.<break time="300ms"/>Qu''ils ont, malgré tout, beaucoup de mérite à recevoir.<break time="700ms"/>C.<break time="300ms"/>Que la conversation a culminé au moment du dessert.<break time="700ms"/>D.<break time="300ms"/>Qu''ils m''ont gentiment raccompagné jusqu''à la porte.</prosody></voice></speak>',
   'Écoutez le document sonore, puis choisissez la bonne réponse parmi les propositions A, B, C ou D.',
   'Procédé : **antiphrase**. Henri loue avec emphase (« rare élévation », « défaillir devant tant d''esprit ») un dîner qu''il a en vérité trouvé ennuyeux ; la dernière question de Denise (« vraiment ? ») invite explicitement à dépasser l''ironie. Seule A « d''une platitude consommée » dit le jugement réel sous l''antiphrase. B propose une **lecture conciliante** (« malgré tout du mérite »), qui adoucit l''antiphrase au lieu de la décoder. C donne **un détail factuel** sur le déroulement du dîner. D donne **un détail mondain de courtoisie**. Une lecture littérale (le compliment) serait insuffisante car elle ignore la modulation ironique demandée par Denise.',
   '[{"label": "A", "is_correct": true, "display_order": 1}, {"label": "B", "is_correct": false, "display_order": 2}, {"label": "C", "is_correct": false, "display_order": 3}, {"label": "D", "is_correct": false, "display_order": 4}]',
   'fr-FR-DeniseNeural', 'TEXT_VALIDATED', NULL, NULL, NULL, NULL, NULL, '2026-05-27 17:40:30.454459+02', NULL, NULL, NULL),

  ('66666666-00c2-1000-0000-000000000002', 'B2', 'co_dialogue_c2_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Que j''ai été littéralement bouleversée par l''ensemble.',
   '<speak version="1.0" xml:lang="fr-FR"><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.</prosody></voice><break time="1500ms"/><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Alors, cette nouvelle exposition au Grand Palais ?</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Disons que je n''en suis pas ressortie indifférente.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Voilà une formule prudente. Cela t''a déplu, alors ?</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Loin s''en faut, vraiment.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Sois plus claire : qu''as-tu réellement éprouvé ?</prosody></voice><break time="1000ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">A.<break time="300ms"/>Que les salles étaient particulièrement bondées ce jour-là.<break time="700ms"/>B.<break time="300ms"/>Que j''ai été déçue, comme à mon habitude désormais.<break time="700ms"/>C.<break time="300ms"/>Que l''affiche promettait davantage qu''elle ne tenait.<break time="700ms"/>D.<break time="300ms"/>Que j''ai été littéralement bouleversée par l''ensemble.</prosody></voice></speak>',
   'Écoutez le document sonore, puis choisissez la bonne réponse parmi les propositions A, B, C ou D.',
   'Procédé : **litote**. « Je n''en suis pas ressortie indifférente » et « loin s''en faut » sont deux atténuations par négation qui signifient un sentiment fort et positif ; Henri presse pour passer du dit (la prudence) au pensé (l''émotion réelle). Seule D « littéralement bouleversée » dit ce sentiment plein. A donne **un détail circonstanciel** (la foule). B propose **la lecture inverse** (déception), incompatible avec « loin s''en faut » qui repousse précisément l''idée d''un déplaisir. C propose **une critique modérée**, ce qui revient à manquer la force positive de la litote. Lire littéralement « pas indifférente » comme « tiède » serait précisément le contresens à éviter.',
   '[{"label": "A", "is_correct": false, "display_order": 1}, {"label": "B", "is_correct": false, "display_order": 2}, {"label": "C", "is_correct": false, "display_order": 3}, {"label": "D", "is_correct": true, "display_order": 4}]',
   'fr-FR-HenriNeural', 'TEXT_VALIDATED', NULL, NULL, NULL, NULL, NULL, '2026-05-27 17:40:30.454459+02', NULL, NULL, NULL),

  ('66666666-00c2-1000-0000-000000000003', 'B2', 'co_dialogue_c2_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Qu''il a travaillé près de deux ans sur ce manuscrit.',
   '<speak version="1.0" xml:lang="fr-FR"><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.</prosody></voice><break time="1500ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Tu as enfin lu le manuscrit de Romain ?</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">C''est un travail très appliqué, on le sent à chaque page.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Très appliqué… mais encore ?</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Oh, il maîtrise vraiment toutes les règles qu''on lui a apprises.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Bref, ton compliment cache quoi, au juste ?</prosody></voice><break time="1000ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">A.<break time="300ms"/>Que je n''ai pas eu le temps de tout lire jusqu''au bout.<break time="700ms"/>B.<break time="300ms"/>Qu''il a manifestement progressé depuis son premier roman.<break time="700ms"/>C.<break time="300ms"/>Qu''il manque cruellement de souffle et d''invention propre.<break time="700ms"/>D.<break time="300ms"/>Qu''il a travaillé près de deux ans sur ce manuscrit.</prosody></voice></speak>',
   'Écoutez le document sonore, puis choisissez la bonne réponse parmi les propositions A, B, C ou D.',
   'Procédé : **compliment ambigu** (faux éloge). « Très appliqué » et « toutes les règles qu''on lui a apprises » sont des adjectifs scolaires qui signalent en creux l''absence d''originalité ; Denise demande explicitement ce que le compliment dissimule. Seule C « manque de souffle et d''invention propre » formule cette réserve cachée. A donne **une excuse personnelle** (lecture inachevée). B donne **une lecture bienveillante** (progrès), qui prend le compliment au pied de la lettre. D donne **un fait extérieur** (durée du travail). Une lecture littérale lirait C comme un éloge ; il faut entendre la sous-évaluation discrète.',
   '[{"label": "A", "is_correct": false, "display_order": 1}, {"label": "B", "is_correct": false, "display_order": 2}, {"label": "C", "is_correct": true, "display_order": 3}, {"label": "D", "is_correct": false, "display_order": 4}]',
   'fr-FR-DeniseNeural', 'TEXT_VALIDATED', NULL, NULL, NULL, NULL, NULL, '2026-05-27 17:40:30.454459+02', NULL, NULL, NULL),

  ('66666666-00c2-1000-0000-000000000005', 'B2', 'co_dialogue_c2_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. À sa fébrilité visible lors de la séance de questions.',
   '<speak version="1.0" xml:lang="fr-FR"><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.</prosody></voice><break time="1500ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Tu disais que la posture de ce ministre te paraissait familière.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Oui, j''avais en tête une figure très précise, en l''écoutant.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Vraiment ?</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Tartuffe, finalement, n''aurait pas mieux composé son visage.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">À quoi tu fais allusion, au juste ?</prosody></voice><break time="1000ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">A.<break time="300ms"/>À la longueur excessive de son intervention télévisée.<break time="700ms"/>B.<break time="300ms"/>À ses positions, qui ont varié au cours du dernier mois.<break time="700ms"/>C.<break time="300ms"/>À une hypocrisie soigneusement mise en scène par ses soins.<break time="700ms"/>D.<break time="300ms"/>À sa fébrilité visible lors de la séance de questions.</prosody></voice></speak>',
   'Écoutez le document sonore, puis choisissez la bonne réponse parmi les propositions A, B, C ou D.',
  ...
  ('66666666-00c2-1000-0000-000000000008', 'B2', 'co_dialogue_c2_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Qu''elle n''est plus considérée comme tout à fait des nôtres.',
   '<speak version="1.0" xml:lang="fr-FR"><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.</prosody></voice><break time="1500ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Tu as vu, on a placé Charlotte au bout de la table, près des enfants.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Tiens donc. Cela n''avait rien d''anodin, je présume.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Bien sûr que non. C''est un message en soi.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Et qu''est-ce qu''on a voulu lui signifier, au juste ?</prosody></voice><break time="1000ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">A.<break time="300ms"/>Qu''elle s''entend particulièrement bien avec les plus jeunes.<break time="700ms"/>B.<break time="300ms"/>Qu''on souhaitait, par cette place, alléger le service à table.<break time="700ms"/>C.<break time="300ms"/>Qu''elle aurait préféré, à l''évidence, dîner ailleurs ce soir-là.<break time="700ms"/>D.<break time="300ms"/>Qu''elle n''est plus considérée comme tout à fait des nôtres.</prosody></voice></speak>',
   'Écoutez le document sonore, puis choisissez la bonne réponse parmi les propositions A, B, C ou D.',
   'Procédé : **sous-entendu mondain (placement à table)**. Le « bout de la table, près des enfants » est, dans le code mondain, une marque symbolique de relégation ; Denise valide explicitement (« message en soi »). Seule D « plus considérée comme tout à fait des nôtres » dit la mise à distance signifiée. A propose **une lecture bienveillante** (affinité avec les enfants). B propose **une justification logistique**, qui nie le caractère intentionnel. C **déplace la question** sur le ressenti de Charlotte plutôt que sur le message envoyé.',
   '[{"label": "A", "is_correct": false, "display_order": 1}, {"label": "B", "is_correct": false, "display_order": 2}, {"label": "C", "is_correct": false, "display_order": 3}, {"label": "D", "is_correct": true, "display_order": 4}]',
   'fr-FR-HenriNeural', 'TEXT_VALIDATED', NULL, NULL, NULL, NULL, NULL, '2026-05-27 17:40:30.454459+02', NULL, NULL, NULL),

  ('66666666-00c2-1000-0000-000000000009', 'B2', 'co_dialogue_c2_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Je rends hommage à mes éditeurs, qui demeurent patients.',
  ...
  ('66666666-00c2-1000-0000-00000000000b', 'B2', 'co_dialogue_c2_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Que le calendrier de mise en œuvre est globalement tenu.',
   '<speak version="1.0" xml:lang="fr-FR"><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.</prosody></voice><break time="1500ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Tu vas reconnaître que la réforme avance, tout de même.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Oh, je veux bien lui accorder le mérite d''exister, à défaut d''agir.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Voilà une concession à double tranchant, je trouve.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Disons que je consens à l''évidence, et rien de plus.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Qu''est-ce que tu concèdes vraiment, alors ?</prosody></voice><break time="1000ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">A.<break time="300ms"/>Que cette réforme produira, à terme, des effets bénéfiques.<break time="700ms"/>B.<break time="300ms"/>Que ses promoteurs ont déployé une énergie remarquable.<break time="700ms"/>C.<break time="300ms"/>Strictement rien, sinon le fait qu''un texte ait été publié.<break time="700ms"/>D.<break time="300ms"/>Que le calendrier de mise en œuvre est globalement tenu.</prosody></voice></speak>',
   'Écoutez le document sonore, puis choisissez la bonne réponse parmi les propositions A, B, C ou D.',
   'Procédé : **concession ironique**. « Le mérite d''exister, à défaut d''agir » et « consens à l''évidence, et rien de plus » sont des concessions minimales qui vident la concession de toute substance ; Denise demande la teneur réelle. Seule C « strictement rien, sinon le fait qu''un texte ait été publié » dit la concession vide. A, B, D proposent **des concessions substantielles** (efficacité, énergie, calendrier), qui prennent la concession au pied de la lettre, alors qu''Henri refuse précisément d''accorder plus que l''existence du texte.',
   '[{"label": "A", "is_correct": false, "display_order": 1}, {"label": "B", "is_correct": false, "display_order": 2}, {"label": "C", "is_correct": true, "display_order": 3}, {"label": "D", "is_correct": false, "display_order": 4}]',
   'fr-FR-DeniseNeural', 'TEXT_VALIDATED', NULL, NULL, NULL, NULL, NULL, '2026-05-27 17:40:30.454459+02', NULL, NULL, NULL),

  ('66666666-00c2-1000-0000-00000000000c', 'B2', 'co_dialogue_c2_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Que ce gouvernement traverse une zone de turbulences passagère.',
   '<speak version="1.0" xml:lang="fr-FR"><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.</prosody></voice><break time="1500ms"/><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Tu crois vraiment que ce gouvernement va tenir jusqu''aux élections ?</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">A-t-on jamais vu une majorité aussi friable durer six mois ?</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Ce n''est pas tout à fait une réponse, ça.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Le passé récent fournit, je crois, tous les éléments de réponse.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Quelle est, en clair, la vraie affirmation derrière ta question ?</prosody></voice><break time="1000ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">A.<break time="300ms"/>Que tu sous-estimes la résilience des coalitions improvisées.<break time="700ms"/>B.<break time="300ms"/>Que beaucoup d''observateurs se trompent depuis quelques mois.<break time="700ms"/>C.<break time="300ms"/>Qu''aucune coalition aussi fragile n''a jamais tenu jusqu''au terme.<break time="700ms"/>D.<break time="300ms"/>Que ce gouvernement traverse une zone de turbulences passagère.</prosody></voice></speak>',
   'Écoutez le document sonore, puis choisissez la bonne réponse parmi les propositions A, B, C ou D.',
   'Procédé : **question rhétorique**. « A-t-on jamais vu une majorité aussi friable durer six mois ? » attend la réponse « non » ; c''est donc une affirmation négative déguisée. Seule C « aucune coalition aussi fragile n''a jamais tenu jusqu''au terme » formule cette affirmation. A **renverse la perspective** (sur Henri). B **déplace la critique** sur d''autres observateurs. D propose **la lecture inverse** (gouvernement durable), qui contredit la question rhétorique.',
   '[{"label": "A", "is_correct": false, "display_order": 1}, {"label": "B", "is_correct": false, "display_order": 2}, {"label": "C", "is_correct": true, "display_order": 3}, {"label": "D", "is_correct": false, "display_order": 4}]',
   'fr-FR-HenriNeural', 'TEXT_VALIDATED', NULL, NULL, NULL, NULL, NULL, '2026-05-27 17:40:30.454459+02', NULL, NULL, NULL),

  ('66666666-00c2-1000-0000-000000000010', 'B2', 'co_dialogue_c2_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Un placard discret, où l''on te laisse sans réelle mission claire.',
   '<speak version="1.0" xml:lang="fr-FR"><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.</prosody></voice><break time="1500ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">On m''a annoncé ce matin un « repositionnement stratégique » de mon poste.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Ouh là. Ce sont des mots à manipuler avec précaution.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Le directeur a évoqué un « ajustement de périmètre temporaire ».</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Voilà des formulations toutes prêtes à amortir un choc.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">À ton avis, qu''est-ce que tout ce vocabulaire adoucit, vraiment ?</prosody></voice><break time="1000ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">A.<break time="300ms"/>Une promotion latérale, somme toute assez flatteuse pour toi.<break time="700ms"/>B.<break time="300ms"/>Un simple changement de bureau, plus proche de la direction.<break time="700ms"/>C.<break time="300ms"/>Une réorganisation neutre, dictée par l''évolution des marchés.<break time="700ms"/>D.<break time="300ms"/>Un placard discret, où l''on te laisse sans réelle mission claire.</prosody></voice></speak>',
   'Écoutez le document sonore, puis choisissez la bonne réponse parmi les propositions A, B, C ou D.',
   'Procédé : **euphémisme à percer**. « Repositionnement stratégique » et « ajustement de périmètre temporaire » sont des formules feutrées du jargon RH qui adoucissent une mise à l''écart ; Henri en signale le caractère amortisseur. Seule D « un placard discret » nomme la réalité brute. A, B, C proposent **trois lectures littérales / bienveillantes** (promotion, changement anodin, contexte de marché) qui prennent l''euphémisme pour vérité au lieu de le percer.',
   '[{"label": "A", "is_correct": false, "display_order": 1}, {"label": "B", "is_correct": false, "display_order": 2}, {"label": "C", "is_correct": false, "display_order": 3}, {"label": "D", "is_correct": true, "display_order": 4}]',
   'fr-FR-HenriNeural', 'TEXT_VALIDATED', NULL, NULL, NULL, NULL, NULL, '2026-05-27 17:40:30.454459+02', NULL, NULL, NULL),

  ('66666666-00c2-1000-0000-000000000011', 'B2', 'co_dialogue_c2_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
...
D. Qu''il vient d''une famille modeste, mais courageuse et estimable.',
   '<speak version="1.0" xml:lang="fr-FR"><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.</prosody></voice><break time="1500ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Tu sais que ma fille fréquente désormais ce jeune Hugo, dont nous parlions.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Ah, le fils Berger. Un garçon, m''a-t-on dit, plein d''avenir.</prosody></voice><voice name="fr-FR-DeniseNeural"><prosody rate="1.0">Plein d''avenir, certes, mais issu d''un milieu si différent du nôtre.</prosody></voice><voice name="fr-FR-HenriNeural"><prosody rate="1.0">Quel implicite sur leur écart de monde tu glisses, là ?</prosody></voice><break time="1000ms"/><voice name="fr-FR-DeniseNeural"><prosody rate="0.95">A.<break time="300ms"/>Qu''il finira par s''adapter sans trop de difficultés à nos usages.<break time="700ms"/>B.<break time="300ms"/>Qu''il n''est pas vraiment des nôtres, et que cela finira par peser.<break time="700ms"/>C.<break time="300ms"/>Qu''il est, malgré tout, un parti tout à fait recommandable pour elle.<break time="700ms"/>D.<break time="300ms"/>Qu''il vient d''une famille modeste, mais courageuse et estimable.</prosody></voice></speak>',
   'Écoutez le document sonore, puis choisissez la bonne réponse parmi les propositions A, B, C ou D.',
   'Procédé : **implicite de classe**. « Issu d''un milieu si différent du nôtre » est une formulation feutrée typique du discours mondain, qui pose une frontière de classe ; le « certes / mais » marque l''opposition entre l''éloge concédé et la réserve réelle. Seule B « il n''est pas vraiment des nôtres, et cela finira par peser » dit le pronostic implicite. A propose **un optimisme intégrateur** que la mère ne formule pas. C propose **un éloge net**, contredit par la concessive. D **adoucit** en éloge moral, sans nommer la distance de classe.',
   '[{"label": "A", "is_correct": false, "display_order": 1}, {"label": "B", "is_correct": true, "display_order": 2}, {"label": "C", "is_correct": false, "display_order": 3}, {"label": "D", "is_correct": false, "display_order": 4}]',
   'fr-FR-HenriNeural', 'TEXT_VALIDATED', NULL, NULL, NULL, NULL, NULL, '2026-05-27 17:40:30.454459+02', NULL, NULL, NULL),

  ('66666666-00c2-1000-0000-000000000013', 'B2', 'co_dialogue_c2_implicite', '22222222-0000-0000-0000-000000000001',
   'Écoutez l''extrait sonore et les quatre propositions. Choisissez la bonne réponse.
