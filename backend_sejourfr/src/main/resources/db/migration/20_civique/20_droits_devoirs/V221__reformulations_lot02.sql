...
('f3000001-0000-0000-0000-000000000011', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CSP', 'MISE_SITUATION',
 ...
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000001-0000-0000-0000-000000000011', 'Oui, c''est un geste citoyen et écologique', TRUE, 0),
...
(gen_random_uuid(), 'f3000001-0000-0000-0000-000000000011', 'Uniquement les retraités', FALSE, 3);
...
('f3000001-0000-0000-0000-000000000013', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'NAT', 'CONNAISSANCE',
 ...
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000001-0000-0000-0000-000000000013', 'Pour protéger l''ordre public, la santé, les droits des autres', TRUE, 0),
...
(gen_random_uuid(), 'f3000001-0000-0000-0000-000000000013', 'Pour réduire les dépenses publiques', FALSE, 3);
...
(gen_random_uuid(), 'f3000001-0000-0000-0000-000000000016', 'Une récompense', FALSE, 3);
...
('f3000001-0000-0000-0000-000000000017', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000001-0000-0000-0000-000000000017', 'Sécurité publique en zones rurales et périurbaines', TRUE, 0),
(gen_random_uuid(), 'f3000001-0000-0000-0000-000000000017', 'Gérer les écoles', FALSE, 1),
...
(gen_random_uuid(), 'f3000001-0000-0000-0000-000000000018', 'Réparer les routes', FALSE, 3);
...
('f3000001-0000-0000-0000-000000000019', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'CONNAISSANCE',
 ...
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000001-0000-0000-0000-000000000019', 'Un acte interdit puni par la loi (contravention, délit, crime)', TRUE, 0),
...
('f3000001-0000-0000-0000-00000000001a', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CSP', 'MISE_SITUATION',
 ...
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000001-0000-0000-0000-00000000001a', 'Trier, composter, éviter les emballages, réparer', TRUE, 0),
(gen_random_uuid(), 'f3000001-0000-0000-0000-00000000001a', 'Tout jeter dans le même sac', FALSE, 1),
(gen_random_uuid(), 'f3000001-0000-0000-0000-00000000001a', 'Brûler les déchets à la maison', FALSE, 2),
...
('f3000001-0000-0000-0000-00000000001b', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 ...
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000001-0000-0000-0000-00000000001b', 'Non, c''est une infraction ; il faut utiliser la déchetterie ou la collecte d''encombrants', TRUE, 0),
...
('f3000001-0000-0000-0000-00000000001c', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'NAT', 'CONNAISSANCE',
 ...
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000001-0000-0000-0000-00000000001c', 'L''exploitation de personnes (travail forcé, prostitution forcée, etc.)', TRUE, 0),
...
('f3000001-0000-0000-0000-00000000001d', 'CIVIQUE', '11111111-0000-0000-0000-000000000003', 'CR', 'MISE_SITUATION',
 ...
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f3000001-0000-0000-0000-00000000001d', 'Porter plainte et se faire accompagner par des associations spécialisées', TRUE, 0),
