...
('f4000002-0000-0000-0000-000000000001', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quelle ville est appelée la ''ville lumiere'' ?',
 'Paris est surnommee la ''ville lumiere'' depuis le XVIIIe siècle. Ce surnom evoque à la fois son rayonnement intellectuel et sa precocite dans l''eclairage public urbain.',
 FALSE);
...
('f4000002-0000-0000-0000-000000000002', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Plusieurs monuments emblematiques se trouvent à Paris : tour Eiffel, Notre-Dame, Louvre, Arc de Triomphe, Pantheon, basilique du Sacre-Cœur.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000004', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Combien la France a-t-elle de côtés maritimes (en simplifie) ?',
 'La France à trois facades maritimes : mer du Nord/Manche au nord, ocean Atlantique à l''ouest, mer Méditerranée au sud, plus les outre-mer.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000006', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quel monument célèbre a été inaugure en 1889 ?',
...
(gen_random_uuid(), 'f4000002-0000-0000-0000-000000000006', 'La basilique du Sacre-Cœur', FALSE, 3);
...
('f4000002-0000-0000-0000-000000000007', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Le drapeau français (bleu-blanc-rouge) est l''embleme de la République. Adopte en 1794, il symbolise l''union du peuple (bleu et rouge, couleurs de Paris) et de la royaute (blanc).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000008', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'La Marseillaise est l''hymne national français. Compose en 1792 à Strasbourg par Rouget de Lisle, il a été adopté definitivement par la IIIe République.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000000a', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quel symbole feminin représente la République française ?',
 'Marianne est l''allegorie de la République française. On la trouve sur les timbres, les pieces, dans les mairies. Elle porte souvent un bonnet phrygien.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000000b', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Le coq gaulois est un embleme officieux de la France. On le retrouve sur les maillots de l''équipe de France de football et de rugby.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000000d', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quel tournoi de tennis est joue à Paris ?',
 'Roland-Garros est le tournoi de tennis français du Grand Chelem, joue chaque année sur terre battue à Paris (Porte d''Auteuil), en mai-juin.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000000e', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Le football est le sport le plus populaire en France. L''équipe de France masculine a remporte la Coupe du monde en 1998 et 2018.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000000f', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Plusieurs produits sont emblematiques de la cuisine française : la baguette de pain, le fromage (camembert, brie, roquefort), le vin, le foie gras, les croissants.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000010', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quel jour ferie célèbre la victoire des Allies en 1945 ?',
 'Le 8 mai est ferie en France. Il commemore la victoire des Allies sur l''Allemagne nazie, le 8 mai 1945, qui a mis fin à la Seconde Guerre mondiale en Europe.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000011', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Le 1er mai est la fête du Travail. C''est un jour ferie en France. On y offre traditionnellement du muguet.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000012', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Le 1er janvier marque le jour de l''An (debut de l''année civile). C''est un jour ferie. On souhaite la bonne année à ses proches.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000013', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quel saint célèbre la fête de la Toussaint, jour ferie ?',
 'La Toussaint, le 1er novembre, est un jour ferie en France. C''est une fête catholique qui honoré tous les saints.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000014', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Notre-Dame de Paris, gravement endommagee par un incendie en avril 2019, a été rouverte au public le 7 décembre 2024 après une restauration majeure.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000015', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Cannes accueille chaque année en mai le Festival international du film, l''un des plus prestigieux au monde. La Palme d''or y est decernee.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000017', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quelle région est célébré pour ses vins (Bordeaux, etc.) ?',
 'La Nouvelle-Aquitaine, autour de Bordeaux, est une des plus grandes régions viticoles de France. D''autres régions viticoles célèbres : Bourgogne, Champagne, Alsace, vallee du Rhone.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000018', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Le Grand Est (anciennes régions Alsace, Lorraine, Champagne-Ardenne), avec Strasbourg pour capitale, est frontaliere de l''Allemagne, du Luxembourg, de la Belgique et de la Suisse.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000019', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Le debarquement allie en Normandie a eu lieu le 6 juin 1944 (D-Day). Il a marqué le debut de la libération de la France et de l''Europe occidentale par les forces alliees.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000001a', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quelle reine française est connue pour avoir été decapitee en 1793 ?',
 'Marie-Antoinette, epouse de Louis XVI, a été guillotinee le 16 octobre 1793 pendant la Révolution française.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000001b', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quel général français a appelé à la resistance le 18 juin 1940 depuis Londres ?',
 'Charles de Gaulle a lancé l''appel du 18 juin 1940 depuis la BBC à Londres, appelant les Français a poursuivre le combat contre l''occupation nazie. Cet appel a fondé la France libre.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000001c', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Louis XIV, qui a regne de 1643 à 1715, est surnomme le ''Roi-Soleil''. Il a fait construire le château de Versailles et a marqué le rayonnement de la France au XVIIe siècle.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000001d', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Le château de Versailles est situé à Versailles, dans les Yvelines, a environ 20 km au sud-ouest de Paris. C''était la résidence des rois de France de Louis XIV a Louis XVI.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f4000002-0000-0000-0000-00000000001d', 'À Versailles, pres de Paris', TRUE, 0),
...
('f4000002-0000-0000-0000-00000000001e', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'La Joconde (Mona Lisa) a été peinte par Leonard de Vinci, peintre italien venu finir ses jours en France à la cour de François Ier (debut XVIe siècle).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000001f', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Jeanne d''Arc (1412-1431) est une héroïne française du Moyen Âge. Elle a libere Orléans, conduit Charles VII a Reims pour son sacré, puis a été brûlée vive a Rouen.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000020', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quel célèbre scientifique française a recu deux prix Nobel ?',
 'Marie Curie (1867-1934), française d''origine polonaise, a obtenu le prix Nobel de physique (1903) et de chimie (1911). Elle a découvert la radioactivite avec son mari Pierre Curie.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000021', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quel chien français est associé a Louis Pasteur ?',
 'Louis Pasteur (1822-1895), chimiste et biologiste français, a invente le vaccin contre la rage en 1885. Il a aussi mis au point la pasteurisation.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000022', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 'Quelle femme politique française a porte la loi sur l''IVG en 1975 ?',
 'Simone Veil (1927-2017), ministre de la Sante, a fait adopter la loi du 17 janvier 1975 depenalisant l''IVG (avortement). Elle est entrée au Pantheon en 2018.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000024', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Le camembert est un fromage normand emblematique, fabrique a base de lait de vache. La Normandie produit aussi le livarot, le pont-l''évêque, le neufchatel.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000025', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'Le croissant est une viennoiserie emblematique du petit-déjeuner français. Inventée a Vienne mais popularisee en France au XIXe siècle.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000028', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'CONNAISSANCE',
 ...
 'La prise de la Bastille a eu lieu le 14 juillet 1789. Cet événement symbolique du debut de la Révolution française est commemore comme fête nationale.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-000000000029', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'MISE_SITUATION',
 ...
 'Beaucoup de monuments offrent accès gratuit le 1er dimanche du mois (notamment musées nationaux). Les Journees du patrimoine en septembre permettent d''entrer dans des lieux d''ordinaire fermes.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000002a', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'MISE_SITUATION',
 ...
 'Le Rhone est le fleuve français qui se jette dans la mer Méditerranée (après Lyon, vers Marseille/la Camargue). Les autres grands fleuves (Seine, Loire, Garonne) se jettent dans l''Atlantique.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000002b', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'MISE_SITUATION',
 ...
 'Il est d''usage de se tenir debout et silencieux pendant la Marseillaise. C''est une marque de respect envers l''hymne national et envers les personnes présentés à la cérémonie.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000002c', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'MISE_SITUATION',
 ...
 'Les Journees européennes du patrimoine ont lieu chaque année le troisième week-end de septembre. De nombreux monuments publics et privés ouvrent leurs portes gratuitement.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000002d', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'MISE_SITUATION',
 ...
 'Il faut respecter les lieux : ne pas toucher les œuvres, ne pas faire de bruit, suivre les indications, ne pas voler ni degrader. Certaines photos peuvent être interditées.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000002e', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'MISE_SITUATION',
 ...
 'Le 14 juillet est la fête nationale française. Il commemore la prise de la Bastille en 1789 (debut de la Révolution) et la fête de la Fédération en 1790 (union nationale).',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
('f4000002-0000-0000-0000-00000000002f', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'MISE_SITUATION',
 'Je veux assister à un defile militaire français. Quel jour est-ce traditionnel ?',
 'Le defile militaire du 14 juillet sur les Champs-Élysées à Paris est le grand defile national français. D''autres cérémonies ont lieu dans les villes de garnison.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
(gen_random_uuid(), 'f4000002-0000-0000-0000-00000000002f', 'Le 14 juillet (defile sur les Champs-Élysées)', TRUE, 0),
...
('f4000002-0000-0000-0000-000000000030', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'MISE_SITUATION',
 ...
 'Le 11 novembre commemore l''armistice signe en 1918, qui a mis fin à la Première Guerre mondiale. C''est l''occasion d''honorer les soldats morts pour la France et de cultiver la mémoire.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
...
(gen_random_uuid(), 'f4000002-0000-0000-0000-000000000030', 'Indépendance de l''Algerie', FALSE, 3);
...
('f4000002-0000-0000-0000-000000000032', 'CIVIQUE', '11111111-0000-0000-0000-000000000004', 'CSP', 'MISE_SITUATION',
 'Je veux ecouter de la musique française classique. Quels compositeurs ?',
 'Parmi les grands compositeurs français : Claude Debussy, Maurice Ravel, Hector Berlioz, Georges Bizet (Carmen), Camille Saint-Saens, Erik Satie.',
 FALSE);
INSERT INTO choices (id, question_id, label, is_correct, display_order) VALUES
