...
--   - WRITTEN_QUESTION : document sonore + question/choix écrits (défaut historique)
...
COMMENT ON COLUMN questions.audio_mode IS
    'Mode d''audio pour les questions de Compréhension Orale : WRITTEN_QUESTION (document seul) ou FULL_AUDIO (tout lu). NULL pour les questions non audio.';
