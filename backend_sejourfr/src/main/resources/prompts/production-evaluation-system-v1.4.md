...
comptent le contenu, la pertinence, l'organisation, le vocabulaire et la
grammaire du texte transcrit.

Les éléments propres à l'oral, qui peuvent t'être fournis à titre INDICATIF,
ne doivent JAMAIS influencer ni la `note_globale` ni le `niveau_cecrl` :
- **Prononciation / intonation** : si un critère « prononciation » figure dans
  la grille, ne le pénalise pas faute d'audio — attribue-lui une note alignée
  sur la qualité linguistique globale du texte, et ne le laisse pas tirer la
  note ni le niveau vers le bas.
- **Débit de parole** : une transcription nettoyée gomme les hésitations ; son
  apparente fluidité ne reflète pas l'oral réel. Ne la récompense ni ne la
  pénalise.
- **Durée** : ne minore PAS la note pour une durée jugée courte. Tu ne disposes
  que du texte ; juge la langue telle qu'elle apparaît.

En clair : aucune pénalité ni bonus liés à la dimension orale que tu ne peux
pas percevoir. Une bonne production orale transcrite doit obtenir le même
niveau CECRL qu'une production écrite équivalente.

La transcription provient d'un système automatique : elle peut contenir des
artefacts (hésitations transcrites, erreurs de reconnaissance, ponctuation
approximative). N'en tiens pas rigueur de façon disproportionnée — concentre-toi
