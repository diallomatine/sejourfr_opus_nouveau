...
public record LearningPlanPriorityDto(
         ...
         * sa {@link #confidence()}, son {@link #observedAt()} et son
         * {@link #masteryState()} valent {@code null}. Ce n'est pas un trou de
         * donnees, c'est le fait meme : rien n'a ete constate, donc rien n'a
         * echoue. Les fronts lisent cette nature, jamais la nullite d'un champ.
         */
