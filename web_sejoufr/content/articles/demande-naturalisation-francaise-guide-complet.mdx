...
author:
  ...
  initials: "AD"
coverIcon: "scale"
coverImage: "https://images.unsplash.com/photo-1622982376381-e4b944344055?w=1600&q=80&fit=crop&auto=format"
...
Le B2 doit être atteint **dans les quatre épreuves** — compréhension orale, compréhension écrite, expression écrite, expression orale. L'attestation affiche un niveau par épreuve : il n'y a **ni moyenne ni compensation**, et un B1 sur une seule d'entre elles suffit à faire recaler le dossier.

Diplômes et tests acceptés :

- **DELF B2**, **DALF C1/C2** ou diplômes équivalents,
- **TCF IRN** avec B2 sur les quatre épreuves (c'est la version *Intégration, Résidence et Nationalité* qui est attendue, pas le TCF tout public — voir [quel TCF passer](/blog/quel-tcf-passer-irn-tout-public-canada-quebec)),
- **TEF IRN** avec B2 sur les quatre épreuves.
...
À l'issue de l'entretien, un **procès-verbal** est rédigé. Il pèse fortement dans la décision finale. L'examen civique et cet entretien sont régulièrement confondus alors qu'ils n'évaluent pas la même chose — nous détaillons leurs différences dans notre article [« Examen civique et entretien d'assimilation : deux épreuves à ne pas confondre »](/blog/examen-civique-entretien-assimilation-difference-naturalisation).
